...
class DeepLabV3(nn.Module):
    def __init__(self, num_classes, backbone):
        ...
        if isinstance(backbone, mobilenetv2):
            ...
            in_channels = 960 if backbone.mode == 'large' else 576
        else:
...
def create_deeplabv3(num_classes, backbone='mobilenetv2', pretrained=False):
    ...
    return DeepLabV3(num_classes, base_net)